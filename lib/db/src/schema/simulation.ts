...
export const simulationConfigTable = pgTable("simulation_config", {
  ...
  dailyWinnersTarget: integer("daily_winners_target").notNull().default(15),
  autoPoolLiveDelaySec: integer("auto_pool_live_delay_sec").notNull().default(3600),
  autoPoolFillWindowSec: integer("auto_pool_fill_window_sec").notNull().default(3600),
