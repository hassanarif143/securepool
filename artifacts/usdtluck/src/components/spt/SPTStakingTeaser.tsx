...
export function SPTStakingTeaser() {
  ...
  return (
    <div className="rounded-xl border border-[var(--green-border)] bg-[var(--green-soft)] p-4 space-y-2">
      <p className="font-semibold text-[var(--green)]">🔒 SPT staking — coming soon</p>
