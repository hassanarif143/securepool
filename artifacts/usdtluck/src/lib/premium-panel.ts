...
export const premiumPanelHead =
  "flex flex-wrap items-center justify-between gap-2 border-b border-white/[0.08] bg-gradient-to-r from-[rgba(12,17,30,0.96)] to-[rgba(6,8,15,0.94)] px-4 py-3.5 sm:px-5";
