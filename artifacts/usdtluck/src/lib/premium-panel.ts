...
export const premiumPanelHead =
  "flex flex-wrap items-center justify-between gap-2 border-b border-white/[0.08] bg-gradient-to-r from-[rgba(12,17,30,0.96)] to-[rgba(6,8,15,0.94)] px-3 py-3 sm:px-4 sm:py-3.5 md:px-5";
